"""Vision providers — object detection, classification, scene understanding."""
...
class VisionPipeline:
    ...
    def register(self, provider: VisionProvider, default: bool = False):
        self._providers[provider.name] = provider
        if default or not self._default:
            self._default = provider.name

    def analyze(self, image_data: bytes, tasks: List[str] = None,
                provider: str = None, prompt: str = None) -> VisionResult:
